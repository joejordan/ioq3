...
function(add_qvm MODULE_NAME)
    ...
    cmake_parse_arguments(ARG "" "" "DEFINITIONS;INCLUDE_DIRECTORIES;OUTPUT_NAME;OUTPUT_DIRECTORY;SOURCES" ${ARGV})
    ...
    endforeach()
    foreach(INCLUDE_DIRECTORY IN LISTS ARG_INCLUDE_DIRECTORIES)
        list(APPEND LCC_FLAGS "-I${INCLUDE_DIRECTORY}")
    endforeach()
